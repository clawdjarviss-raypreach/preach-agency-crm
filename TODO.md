# Dashboard v0 — TODO (AUTO-GENERATED)
...
- [x] End-to-end workflow: clock-in → shift approval → payroll gen → apply bonuses → approve → mark paid → CSV export (priority: Medium)
- [x] Role-gated routing for admin/supervisor/chatter areas (priority: Medium)
- [x] Bonus rules CRUD + toggles + validation (priority: Medium)
